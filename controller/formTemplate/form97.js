...
<div class="page1">
  ...
  <div class="section1" style="word-spacing: 10px;">
   Petition for Probate of the last Will and Testament of  <span class="bold">${data.deceasedFullName || ".................................."}</span>, 
...
<div class="page-break page2">
  ...
  That the said deceased at the time of his death had a fixed place of abode at <span class="bold">${data.placeOfAbode || ".................................."}</span> and/or left property within Greater Bombay and in the State of Maharashtra and elsewhere in India.
  </div>
  <br>

  <div style="word-spacing: 10px;"><span style="margin-right:15px;">(3)</span>
  That the said deceased left a writing, which is his last Will and testament. The said writing, hereinafter referred to as “the Will”, is marked as Exhibit "<span class="bold">${data.exhibitNumber3 || ".................................."}</span>" and is handed in separately for being filed and kept in a safe place in the 
  </div>
</div>
...
<div class="page-break page3">
  ...
  That the Petitioner is the <span class="bold">${data.capacity || ".................................."}</span> named in the said Will or the Executor according to the tenor thereof.
  </div>
  <br>
  <div style="word-spacing: 10px;"><span style="margin-right:15px;">(6)</span>
  The Petitioner has truly set forth in Schedule No.I, hereto annexed and marked as Exhibit “<span class="bold">${data.exhibitNumber5 || ".................................."}</span>”, all the property and credits which the Deceased died possessed of or entitled to at the time of his death, which have or are likely to come to his hands.
  </div>
</div>
...
<div class="page-break page4">
  ...
  That the Petitioner has truly set forth in Schedule No. II, hereto annexed and marked Exhibit “<span class="bold">${data.exhibitNumber6 || ".................................."}</span>” all the items that by law, he is allowed to deduct for the purpose of ascertaining the net estate of the Deceased.
  </div>
  <br>
  <div style="word-spacing: 10px;"><span style="margin-right:20px;">(8)</span>
  That, the Petitioner has truly set forth in Schedule No. III, hereto annexed and marked Exhibit “<span class="bold">${data.exhibitNumber7 || ".................................."}</span>” the property held by the Deceased as a trustee for another and not beneficially or with general power to confer a beneficial interest.
  </div>
  <br>
  <div style="word-spacing: 10px;"><span style="margin-right:15px;">(9)</span>
  That the assets of the Deceased after deducting the items mentioned in Schedule No. II but including all rents; interest and dividends which have accrued since the date of the death of the Deceased and increased value of the assets since the said date are of the value of Rs. <span class="bold">${data.schduleAmount || ".................................."}</span>.
  </div>
  <br>
  <div style="word-spacing: 10px;"><span style="margin-right:15px;">(10)</span>
  That the said Deceased left him surviving as his only heirs and next-of-kin according to <span class="bold">${data.lawApplicableToTheDeceased || ".................................."}</span>, the following persons, who are residing at the addresses set out
